...
<!-- LW: In the presentation 2 are also the following topics:
Encoding Value - an Overview F41 (Univariate data, Bivariate data, Trivariate data, Multivariate data)
What would you like to show F42 (which chart is good for comparison, relationship, distribution, composition) 
Techniques discussed in this course F44 + Python Libraries F45 (would be better in chapter 4 Visualization Techniques I think -->
